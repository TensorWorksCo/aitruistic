    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background">
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href="/future" className="flex items-center gap-2">
          ...
          <nav className="hidden md:flex items-center gap-0.5">
            ...
            <Link
              ...
              className={cn(
                "px-2 py-2 text-xs lg:text-sm font-medium rounded-md transition-colors hover:bg-muted",
                pathname === "/future/events" && "bg-muted"
              )}
            >
              Events
            </Link>
            ...
            <Link
              ...
              className={cn(
                "px-2 py-2 text-xs lg:text-sm font-medium rounded-md transition-colors hover:bg-muted",
                pathname === "/future/projects" && "bg-muted"
              )}
            >
              Projects
            </Link>
            ...
            <Link
              ...
              className={cn(
                "px-2 py-2 text-xs lg:text-sm font-medium rounded-md transition-colors hover:bg-muted",
                pathname === "/future/about" && "bg-muted"
              )}
            >
              About
            </Link>
          ...
          {session ? (
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                {isModerator && (
                  <>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem asChild>
                      <Link href="/future/admin" className="cursor-pointer">
            ...
            <div className="hidden md:flex items-center gap-2">
              <Button variant="ghost" asChild>
                <Link href="/future/auth/signin">Sign in</Link>
              </Button>
              <Button asChild>
                <Link href="/future/auth/signup">Join us</Link>
              </Button>
            </div>
          )}
